...
abstract contract SnapshotsStorageV2 is ImmutableETHDKG, ImmutableValidatorPool, SnapshotRingBuffer {
    ...
    function snapshotsBuffer() internal override view returns(SnapshotBuffer storage){
        return __snapshots;
    }
    
    function epochReg() internal override view returns(Epoch storage){
        return __epoch;
    }
}