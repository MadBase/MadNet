...
library MerkleProofLibrary {
    ...
    /// @notice Computes the leaf hash.
    /// @param _proof the struct with MerkleProof elements
    /// @return the leaf hash
    function computeLeafHash2(MerkleProofParserLibrary.MerkleProof memory _proof)
        internal
        pure
        returns (bytes32)
    {
