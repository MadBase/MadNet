...
library BridgePoolErrorCodes {
    ...
    bytes32 public constant BRIDGEPOOL_COULD_NOT_TRANSFER_DEPOSIT_AMOUNT_FROM_SENDER = "2404";
    bytes32 public constant BRIDGEPOOL_COULD_NOT_TRANSFER_DEPOSIT_FEE_FROM_SENDER = "2405";
}
