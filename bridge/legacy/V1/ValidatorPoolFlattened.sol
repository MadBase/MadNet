...
library ValidatorPoolErrorCodes {
    ...
    bytes32 public constant VALIDATORPOOL_REGISTRATION_PARAMETER_LENGTH_MISMATCH = "806"; //"ValidatorPool: Both input array should have same length!"
    ...
    bytes32 public constant VALIDATORPOOL_VALIDATORS_GREATER_THAN_AVAILABLE = "808"; //"ValidatorPool: There are not enough validators to be removed!"
    bytes32 public constant VALIDATORPOOL_PROFITS_ONLY_CLAIMABLE_DURING_CONSENSUS = "809"; //"ValidatorPool: Profits can only be claimable when consensus is running!"
    ...
    bytes32 public constant VALIDATORPOOL_DISHONEST_VALIDATOR_NOT_ACCUSABLE = "814"; //"ValidatorPool: DishonestValidator should be a validator or be in the exiting line!"
