...
func TestCriteria(t *testing.T) {
	...
	tests := []testStruct{
		{h: []handler{
			&nrCurrentHandler{rs: roundStates, NRCurrent: true, external: stateHandler.nrCurrentFunc},
			&pcCurrentHandler{rs: roundStates, PCCurrent: false, external: stateHandler.pcCurrentFunc},
			&pcnCurrentHandler{rs: roundStates, PCNCurrent: false, external: stateHandler.pcnCurrentFunc},
			&pvCurrentHandler{rs: roundStates, PVCurrent: false, external: stateHandler.pvCurrentFunc},
			&pvnCurrentHandler{rs: roundStates, PVNCurrent: false, external: stateHandler.pvnCurrentFunc},
			&ptoExpiredHandler{rs: roundStates, external: stateHandler.ptoExpiredFunc},
			&validPropHandler{rs: roundStates, PCurrent: false, external: stateHandler.validPropFunc},
		}, expectedCaseSelected: 0},
		{h: []handler{
			&nrCurrentHandler{rs: roundStates, NRCurrent: false},
			&pcCurrentHandler{rs: roundStates, PCCurrent: true},
			&pcnCurrentHandler{rs: roundStates, PCNCurrent: false},
			&pvCurrentHandler{rs: roundStates, PVCurrent: false},
			&pvnCurrentHandler{rs: roundStates, PVNCurrent: false},
			&ptoExpiredHandler{rs: roundStates},
			&validPropHandler{rs: roundStates, PCurrent: false},
		}, expectedCaseSelected: 1},
		{h: []handler{
			&nrCurrentHandler{rs: roundStates, NRCurrent: false},
			&pcCurrentHandler{rs: roundStates, PCCurrent: false},
			&pcnCurrentHandler{rs: roundStates, PCNCurrent: true},
			&pvCurrentHandler{rs: roundStates, PVCurrent: false},
			&pvnCurrentHandler{rs: roundStates, PVNCurrent: false},
			&ptoExpiredHandler{rs: roundStates},
			&validPropHandler{rs: roundStates, PCurrent: false},
		...
		{h: []handler{
			...
			&pcCurrentHandler{rs: roundStates, PCCurrent: false},
			&pcnCurrentHandler{rs: roundStates, PCNCurrent: false},
			&pvCurrentHandler{rs: roundStates, PVCurrent: true},
			&pvnCurrentHandler{rs: roundStates, PVNCurrent: false},
			&ptoExpiredHandler{rs: roundStates},
			&validPropHandler{rs: roundStates, PCurrent: false},
		...
		{h: []handler{
			...
			&pcnCurrentHandler{rs: roundStates, PCNCurrent: false},
			&pvCurrentHandler{rs: roundStates, PVCurrent: false},
			&pvnCurrentHandler{rs: roundStates, PVNCurrent: true},
			&ptoExpiredHandler{rs: roundStates},
			&validPropHandler{rs: roundStates, PCurrent: false},
