...
clean:
	...
	rm -rf localrpc/swagger-bindata/bindata.go localrpc/swagger/localstate.swagger.json **/*.pb.go **/*.capnp.go **/*.pb.gw.go **/*_mngen.go **/*_mngen_test.go test/mocks/*.mockgen.go bridge/artifacts bridge/bindings bridge/cache bridge/typechain-types