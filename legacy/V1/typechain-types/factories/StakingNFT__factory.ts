...
import type { StakingNFT, StakingNFTInterface } from "../StakingNFT";
...
export class StakingNFT__factory {
    static readonly abi = _abi;
    static createInterface(): StakingNFTInterface {
        return new utils.Interface(_abi) as StakingNFTInterface;
    }
    static connect(
        address: string,
        signerOrProvider: Signer | Provider
    ): StakingNFT {
        return new Contract(address, _abi, signerOrProvider) as StakingNFT;
    }
}
