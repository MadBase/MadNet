...
export class IValidatorPool__factory {
    static readonly abi = _abi;
    static createInterface(): IValidatorPoolInterface {
        return new utils.Interface(_abi) as IValidatorPoolInterface;
    }
    static connect(
        address: string,
        signerOrProvider: Signer | Provider
    ): IValidatorPool {
        return new Contract(address, _abi, signerOrProvider) as IValidatorPool;
    }
}
