...
export interface ReentrantFiniteBurnAccountInterface extends utils.Interface {
    contractName: "ReentrantFiniteBurnAccount";
    functions: {
...
export interface ReentrantFiniteBurnAccount extends BaseContract {
    contractName: "ReentrantFiniteBurnAccount";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: ReentrantFiniteBurnAccountInterface;
