...
export interface IMockEndPointLockableInterface extends utils.Interface {
    contractName: "IMockEndPointLockable";
    functions: {
...
export interface IMockEndPointLockable extends BaseContract {
    contractName: "IMockEndPointLockable";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: IMockEndPointLockableInterface;
