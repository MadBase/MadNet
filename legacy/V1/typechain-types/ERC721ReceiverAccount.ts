...
export interface ERC721ReceiverAccountInterface extends utils.Interface {
    contractName: "ERC721ReceiverAccount";
    functions: {
...
export interface ERC721ReceiverAccount extends BaseContract {
    contractName: "ERC721ReceiverAccount";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: ERC721ReceiverAccountInterface;
