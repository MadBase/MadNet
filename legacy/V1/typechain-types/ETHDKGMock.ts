...
export interface ETHDKGMockInterface extends utils.Interface {
    contractName: "ETHDKGMock";
    functions: {
        ...
        "setConsensusRunning()": FunctionFragment;
...
export interface ETHDKGMock extends BaseContract {
    contractName: "ETHDKGMock";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: ETHDKGMockInterface;
    ...
    callStatic: {
        ...
        setConsensusRunning(overrides?: CallOverrides): Promise<void>;
