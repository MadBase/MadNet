...
export interface ExternalStoreRegistrationInterface extends utils.Interface {
    contractName: "ExternalStoreRegistration";
    functions: {
        "getCounter()": FunctionFragment;
        "getMetamorphicContractAddress(bytes32,address)": FunctionFragment;
        "getTokenIDsLength()": FunctionFragment;
        "getTokenIds()": FunctionFragment;
        "incrementCounter()": FunctionFragment;
        "storeTokenIds(uint256[])": FunctionFragment;
    };
    ...
    encodeFunctionData(
        functionFragment: "getTokenIDsLength",
        values?: undefined
    ): string;
    encodeFunctionData(
...
export interface ExternalStoreRegistration extends BaseContract {
    contractName: "ExternalStoreRegistration";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: ExternalStoreRegistrationInterface;
    ...
    functions: {
        ...
        getTokenIDsLength(overrides?: CallOverrides): Promise<[BigNumber]>;
