...
export interface ValidatorPoolMockInterface extends utils.Interface {
    contractName: "ValidatorPoolMock";
    functions: {
        "MAX_INTERVAL_WITHOUT_SNAPSHOTS()": FunctionFragment;
        "POSITION_LOCK_PERIOD()": FunctionFragment;
        "burnToValidatorStaking(uint256,address)": FunctionFragment;
        "burnValidatorStaking(uint256)": FunctionFragment;
        ...
        "mintToValidatorStaking(address)": FunctionFragment;
        "mintValidatorStaking()": FunctionFragment;
        ...
        "setConsensusRunning(bool)": FunctionFragment;
        ...
        "setSnapshot(address)": FunctionFragment;
    ...
    encodeFunctionData(
        functionFragment: "burnToValidatorStaking",
        values: [BigNumberish, string]
    ): string;
    encodeFunctionData(
        functionFragment: "burnValidatorStaking",
        values: [BigNumberish]
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        functionFragment: "mintToValidatorStaking",
        values: [string]
    ): string;
    encodeFunctionData(
        functionFragment: "mintValidatorStaking",
        values?: undefined
    ): string;
    encodeFunctionData(
    ...
    encodeFunctionData(
        functionFragment: "setConsensusRunning",
        values: [boolean]
    ): string;
    encodeFunctionData(
...
export interface ValidatorPoolMock extends BaseContract {
    contractName: "ValidatorPoolMock";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;

    interface: ValidatorPoolMockInterface;
    ...
    functions: {
        ...
        burnToValidatorStaking(
            tokenID_: BigNumberish,
            to_: string,
            overrides?: Overrides & { from?: string | Promise<string> }
        ): Promise<ContractTransaction>;

        burnValidatorStaking(
            tokenID_: BigNumberish,
            overrides?: Overrides & { from?: string | Promise<string> }
        ): Promise<ContractTransaction>;
        ...
        mintToValidatorStaking(
            to_: string,
            overrides?: Overrides & { from?: string | Promise<string> }
        ): Promise<ContractTransaction>;

        mintValidatorStaking(
            overrides?: Overrides & { from?: string | Promise<string> }
        ): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mintValidatorStaking(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        setSnapshot(_address: string, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        collectProfits(overrides?: CallOverrides): Promise<BigNumber>;
