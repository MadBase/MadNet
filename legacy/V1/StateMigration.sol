    ...
    ImmutableValidatorPool
{
    ...
    function stakeValidators() public {
        ...
        for (uint256 i; i < 4; i++) {
            ...
            IERC721(_publicStakingAddress()).approve(
    ...
    function migrateSnapshotsAndValidators() public {
        ...
        validatorsAccounts_[0] = address(
            uint160(
                0x000000000000000000000000b80d6653f7e5b80dbbe8d0aa9f61b5d72e8028ad
            )
        );
        validatorsAccounts_[1] = address(
            uint160(
                0x00000000000000000000000025489d6a720663f7e5253df68948edb302dfdcb6
            )
        );
        validatorsAccounts_[2] = address(
            uint160(
                0x000000000000000000000000322e8f463b925da54a778ed597aef41bc4fe4743
            )
        );
        validatorsAccounts_[3] = address(
            uint160(
                0x000000000000000000000000adf2a338e19c12298a3007cbea1c5276d1f746e0
            )
        );

        IValidatorPool(_validatorPoolAddress()).registerValidators(
            validatorsAccounts_,
            tokenIDs
        );
        ///////////////
        ...
        ISnapshots(_snapshotsAddress()).migrateSnapshots(
            groupSignatures_,
            bClaims_
        );
    }
