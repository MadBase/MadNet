...
// File @openzeppelin/contracts/utils/math/SignedSafeMath.sol@v4.5.0
...
// File contracts/libraries/errorCodes/Base64ErrorCodes.sol

// SPDX-License-Identifier: MIT-open-group
pragma solidity ^0.8.11;

library Base64ErrorCodes {
    // Base64ErrorCodes error codes
    bytes32 public constant BASE64_INVALID_INPUT = "1800"; //"invalid base64 decoder input"
}
...
library StakingSVG {
    ...
    function generateSVG(StakingSVGParams memory params)
        internal
        pure
...
library StakingDescriptor {
    ...
    function generateSVGImage(ConstructTokenURIParams memory params)
        ...
        returns (string memory svg)
    {
        StakingSVG.StakingSVGParams memory svgParams = StakingSVG
            .StakingSVGParams({
        ...
        returns (string memory)
    {
        return
            string(
                abi.encodePacked(
                    "AliceNet Staked token for position #",
                    params.tokenId.toString()
                )
            );
    }
